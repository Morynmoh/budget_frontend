...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  void _signup() async {
    ...
    String name = _nameController.text.trim(); // Capture name
    String email = _emailController.text.trim();
    String password = _passwordController.text.trim();

    try {
      await _apiService.signup(name, email, password); // Pass name to signup
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextField(
              controller:
                  _nameController, // Set the controller for the name field
